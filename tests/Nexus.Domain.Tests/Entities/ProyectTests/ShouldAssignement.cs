...
namespace Nexus.Domain.Tests.Entities.ProyectTests
{
    public class ShouldAssignement
    {
        ...
        [Fact]
        public void CancelAssignementShouldWork()
        {
            var proyect = Proyect.Create(
                "proyecto1",
                100000000,
        ...
        [Fact]
        public void FinishAssignementShouldWork()
        {
            var proyect = Proyect.Create(
                "proyecto1",
                100000000,
        ...
        [Fact]
        public void OverduehAssignementShouldWork()
        {
            var proyect = Proyect.Create(
                "proyecto1",
                100000000,
            ...
            Assert.True(result.OverdueFlag == true);
